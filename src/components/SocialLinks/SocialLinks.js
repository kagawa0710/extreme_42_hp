  ...
  render () {
    ...
    return (
      ...
      >
        ...
        <A href='https://twitter.com/42_extreme' title='Twitter' target='twitter'>
          <span className='mdi mdi-twitter' />
        </A>
        <A href='https://www.instagram.com/42_extreme' title='Instagram' target='instagram'>
          <span className='mdi mdi-instagram' />
        </A>
        <A href='mailto:42_extremeactivities@gmail.com' title='Email' target='email'>
